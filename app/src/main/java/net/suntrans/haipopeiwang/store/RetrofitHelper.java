...
//    public static final String BASE_URL = "http://appone.suntrans.net/api.php/";
    public static final String BASE_URL = "https://api.weixin.qq.com/";//请求wx openId的
    public static final String BASE_URL2 = "https://hpjd.suntrans-cloud.com/";
    public static final String BASE_URL3 = "https://hpjd.suntrans-cloud.com/api/jingdong/weixin/";
    ...
    private static void initOkHttpClient() {
        ...
        Interceptor netInterceptor = new Interceptor() {
            ...
            public Response intercept(Chain chain) throws IOException {
                String header = App.Companion.getSharedPreferences().getString("access_token", "-1");
