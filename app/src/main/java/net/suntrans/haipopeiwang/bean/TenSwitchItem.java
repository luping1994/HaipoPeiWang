...
public class TenSwitchItem implements Parcelable {
    private String name;
    ...
    protected TenSwitchItem(Parcel in) {
    ...
    public static final Creator<TenSwitchItem> CREATOR = new Creator<TenSwitchItem>() {
        @Override
        public TenSwitchItem createFromParcel(Parcel source) {
            return new TenSwitchItem(source);
        }

        @Override
        public TenSwitchItem[] newArray(int size) {
            return new TenSwitchItem[size];
        }
    };
